...
export const ko: Record<TranslationKey, string> = {
  ...
  // Voice Note
  "audio.voiceNote": "음성 노트",
  "audio.recording": "녹음",
  "audio.recordingActive": "녹음 중...",
  "audio.recordingFinished": "녹음 완료",
  "audio.readyToRecord": "녹음 준비됨",
  "audio.startRecording": "녹음 시작",
  "audio.stop": "정지",
  "audio.save": "저장",
  "audio.recordAgain": "다시 녹음",
  "audio.discard": "버리기",
  "audio.deleteRecording": "녹음 삭제",
  "audio.noRecordingsYet": "아직 녹음이 없습니다",
  "audio.microphoneRequired": "오디오를 녹음하려면 마이크 접근 권한이 필요합니다.",
  "audio.notSupported": "이 브라우저에서는 오디오 녹음을 지원하지 않습니다.",
  "audio.maxDurationReached": "최대 길이에 도달했습니다",
  "audio.confirmDiscard": "이 녹음을 버리시겠습니까?",
  "audio.confirmDelete": "이 녹음을 삭제하시겠습니까?",
  "audio.storageNoticeTitle": "오디오 저장 안내",
  "audio.storageNoticeMessage": "오디오 녹음은 이 기기에 로컬로 저장됩니다. 브라우저/앱 캐시 또는 사이트 데이터를 지우면 녹음이 삭제될 수 있습니다. 백업을 위해 JSON을 내보내거나 오디오를 다운로드하세요.",
  "audio.storageNoticeDontShowAgain": "다시 표시하지 않기",
  "audio.storageNoticeCancel": "취소",
  "audio.storageNoticeContinue": "계속",
  "audio.play": "재생",
  "audio.pause": "일시정지",
  "audio.take": "테이크",
  "audio.recordingCount": "녹음",
  "audio.recordingCountPlural": "녹음",
  ...
  "toast.audioNotAvailable": "오디오 파일을 사용할 수 없습니다.",
