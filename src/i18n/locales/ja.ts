...
export const ja: Record<TranslationKey, string> = {
  ...
  // Voice Note
  "audio.voiceNote": "ボイスノート",
  "audio.recording": "録音",
  "audio.recordingActive": "録音中...",
  "audio.recordingFinished": "録音完了",
  "audio.readyToRecord": "録音準備完了",
  "audio.startRecording": "録音開始",
  "audio.stop": "停止",
  "audio.save": "保存",
  "audio.recordAgain": "もう一度録音",
  "audio.discard": "破棄",
  "audio.deleteRecording": "録音を削除",
  "audio.noRecordingsYet": "録音はまだありません",
  "audio.microphoneRequired": "音声を録音するにはマイクへのアクセスが必要です。",
  "audio.notSupported": "このブラウザでは音声録音に対応していません。",
  "audio.maxDurationReached": "最大時間に達しました",
  "audio.confirmDiscard": "この録音を破棄してもよろしいですか？",
  "audio.confirmDelete": "この録音を削除してもよろしいですか？",
  "audio.storageNoticeTitle": "音声保存のお知らせ",
  "audio.storageNoticeMessage": "音声録音はこのデバイスにローカル保存されます。ブラウザ/アプリのキャッシュやサイトデータを消去すると、録音が削除される場合があります。バックアップのためにJSONをエクスポートするか、音声をダウンロードしてください。",
  "audio.storageNoticeDontShowAgain": "今後表示しない",
  "audio.storageNoticeCancel": "キャンセル",
  "audio.storageNoticeContinue": "続行",
  "audio.play": "再生",
  "audio.pause": "一時停止",
  "audio.take": "テイク",
  "audio.recordingCount": "録音",
  "audio.recordingCountPlural": "録音",
  ...
  "toast.audioNotAvailable": "音声ファイルを利用できません。",
