...
export const sv: Record<TranslationKey, string> = {
  ...
  "editor.expandStyle": "Expandera stil",
  "editor.removeAll": "Ta bort allt",
  "editor.textRange": "Text",
  "editor.textRangeHint": "Markera detta textintervall",
  "editor.copyRange": "Kopiera",
  "editor.copyAll": "Kopiera allt",
  "myStyles.button": "Mina stilar",
  "myStyles.title": "Mina stilar",
  "myStyles.intro": "Spara dina egna stilprompter och återanvänd dem i vilken låt som helst.",
  "myStyles.saveCurrent": "Spara aktuell stil",
  "myStyles.namePlaceholder": "Stilnamn",
  "myStyles.save": "Spara",
  "myStyles.rename": "Byt namn",
  "myStyles.delete": "Ta bort",
  "myStyles.empty": "Inga sparade stilar ännu.",
  "myStyles.emptyStyle": "Stilen är tom. Skriv eller infoga en stil först.",
  "myStyles.nameRequired": "Ange ett namn.",
  "myStyles.saved": "Stil sparad",
  "myStyles.renamed": "Stilen har bytt namn",
  ...
  "share.pdfHint": "Dela den här låten som en PDF-fil.",
  "share.audioHint": "Dela låtens inspelning.",
